...
export const routes: Routes = [
  ...
  },
  {
    path: 'categories',
    loadComponent: () =>
      import('./category/category-list/category-list.component').then((m) => m.CategoryList),
  },
  {
    path: 'authors',
    loadComponent: () =>
      import('./author/author-list/author-list.component').then((m) => m.AuthorListComponent),
  },
  {
    path: 'games',
    loadComponent: () =>
